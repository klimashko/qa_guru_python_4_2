...
def test_search_text(set_size_browser_window_open):
...
def test_another_text_search(set_size_browser_window_open):
...
def test_text_random_search(set_size_browser_window_open):
